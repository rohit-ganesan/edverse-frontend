...
export function EmptySessionState({
  ...
  return (
    <RadixCard className={`p-12 text-center dark:bg-gray-800 ${className}`}>
      <Flex direction="column" align="center" gap="4">
        <Box className="w-16 h-16 bg-gray-100 dark:bg-gray-900 rounded-full flex items-center justify-center">
          <Camera className="w-8 h-8 text-gray-400" />
        </Box>
        <Box>
          <Heading size="4" className="text-gray-900 dark:text-gray-100 mb-2">
            {safeTitle}
          </Heading>
