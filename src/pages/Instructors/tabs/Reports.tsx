...
export function Reports(): JSX.Element {
  ...
  const recentReports = [
    {
      id: 1,
      name: 'Performance Summary - November 2024',
  ...
  const scheduledReports = [
    ...
    },
    {
      ...
      format: 'Excel',
      recipients: 'finance@school.edu, hr@school.edu',
      status: 'active',
      nextRun: '2024-11-30',
      lastRun: '2024-10-31',
      category: 'payroll',
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      if (selectedReportType === 'performance-summary') {
        handleExportInstructors(instructors, 'csv');
      }
  ...
  if (error) {
    return (
      <Box className="flex items-center justify-center h-64">
        <Text className="text-red-500">Error loading reports: {error}</Text>
      </Box>
    );
  }
          ...
          <Flex justify="between" align="center" className="mb-6">
            <Box>
              ...
              <Text size="3" className="text-gray-600">
                Create comprehensive reports for {instructors?.length || 0}{' '}
                instructors
              </Text>
            </Box>
            <Flex gap="2">
      ...
      <RadixCard className="p-0 shadow-xl border-0 bg-white overflow-hidden">
        ...
        <Box className="p-6 bg-gradient-to-r from-orange-50 to-amber-50 border-b border-orange-100">
          <Flex justify="between" align="center">
            ...
            <RadixButton size="2" className="bg-orange-600 hover:bg-orange-700">
